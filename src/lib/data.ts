...
export const bodyPartsData: BodyPart[] = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        category: "Krční páteř",
        difficulty: "Střední",
        equipment: "Váhový kotouč",
        description: "Vleže na lavičce s hlavou přes okraj, zvedejte váhu přitaženou k čelu. Posiluje přední krční svaly.",
      },
      {
        id: "neck-5",
        name: "Neck Extension",
        ...
        difficulty: "Střední",
        equipment: "Váhový kotouč",
        description: "Vleže na břiše s hlavou přes okraj lavičky, zvedejte váhu položenou na záhlaví. Posiluje zadní krční svaly.",
      },
      {
        id: "neck-6",
        name: "Shrugy s jednoručkami",
        category: "Krční páteř",
        difficulty: "Začátečník",
        equipment: "Jednoručky",
        description: "Zvedání ramen směrem k uším s jednoručkami. Cílí na horní trapéz a krční oblast.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        description: "Tlak velkou činkou nad hlavu ve stoje. Základní silový cvik na ramena a celkovou stabilitu.",
      },
      {
        id: "shoulders-10",
        ...
        difficulty: "Střední",
        equipment: "Kladka",
        description: "Upažování na spodní kladce. Konstantní napětí v celém rozsahu pohybu pro lepší izolaci deltoidů.",
      },
      {
        id: "shoulders-11",
        ...
        difficulty: "Začátečník",
        equipment: "Stroj",
        description: "Obrácené rozpažování na stroji. Izoluje zadní deltoidy a mezilopatkové svaly.",
      },
      {
        id: "shoulders-12",
        name: "Landmine Press",
        ...
        difficulty: "Střední",
        equipment: "Velká činka",
        description: "Tlak činky ukotvené v rohu. Šetrnější pro ramena než klasický overhead press díky úhlové dráze.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        difficulty: "Střední",
        equipment: "Kladka",
        description: "Křížení kladek před tělem. Izoluje prsní svaly s konstantním napětím v celém rozsahu pohybu.",
      },
      {
        id: "chest-13",
        ...
        difficulty: "Střední",
        equipment: "Jednoručky",
        description: "Tlaky jednoručkami na šikmé lavici (30-45°). Cílí na horní část prsních svalů.",
      },
      {
        id: "chest-14",
        name: "Pec Deck",
        ...
        difficulty: "Začátečník",
        equipment: "Stroj",
        description: "Rozpažování/spažování na stroji. Bezpečná izolace prsních svalů s vedeným pohybem.",
      },
      {
        id: "chest-15",
        name: "Floor Press",
        ...
        difficulty: "Střední",
        equipment: "Jednoručky",
        description: "Tlaky jednoručkami vleže na zemi. Omezený rozsah pohybu chrání ramena a buduje sílu v lockoutu.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        difficulty: "Střední",
        equipment: "EZ činka",
        description: "Bicepsový zdvih na opěrce (Scottově lavici). Eliminuje švih a izoluje biceps v celém rozsahu.",
      },
      {
        id: "arms-12",
        ...
        difficulty: "Střední",
        equipment: "Jednoručky",
        description: "Tricepsový přítah jednoručkou za hlavou. Natahuje dlouhou hlavu tricepsu pro maximální aktivaci.",
      },
      {
        id: "arms-13",
        ...
        difficulty: "Začátečník",
        equipment: "Jednoručky",
        description: "Bicepsový zdvih v sedě s loktem opřeným o stehno. Maximální izolace a kontrola pohybu.",
      },
      {
        id: "arms-14",
        ...
        difficulty: "Pokročilý",
        equipment: "Velká činka",
        description: "Bench press s úzkým úchopem. Primárně cílí na triceps s vysokou zátěží.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        difficulty: "Pokročilý",
        equipment: "Ab wheel",
        description: "Rolování kolečkem z kleku do natažení a zpět. Extrémně efektivní na celé břicho a core stabilizátory.",
      },
      {
        id: "abs-11",
        name: "Cable Crunch",
        ...
        difficulty: "Střední",
        equipment: "Kladka",
        description: "Zkracovačky na horní kladce v kleku. Umožňuje progresivní přetěžování břišních svalů.",
      },
      {
        id: "abs-12",
        ...
        difficulty: "Střední",
        equipment: "Hrazda",
        description: "Přitahování kolen k hrudníku ve visu na hrazdě. Cílí na spodní břicho a hip flexory.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        description: "Komplexní pohyb ze země do stoje s kettlebellem nad hlavou. Buduje stabilitu, mobilitu a sílu celého těla.",
      },
      {
        id: "core-11",
        name: "Farmer's Walk",
        ...
        difficulty: "Střední",
        equipment: "Jednoručky",
        description: "Chůze s těžkými jednoručkami. Posiluje úchop, trapézy a celý core díky stabilizaci trupu při chůzi.",
      },
      {
        id: "core-12",
        name: "Suitcase Carry",
        ...
        difficulty: "Střední",
        equipment: "Jednoručky",
        description: "Chůze s jednoručkou pouze v jedné ruce. Anti-laterální flexe — core musí bránit úklonu trupu.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        difficulty: "Střední",
        equipment: "T-bar",
        description: "Přítahy na T-bar stroji v předklonu. Umožňuje vysokou zátěž pro budování hustoty středu zad.",
      },
      {
        id: "back-11",
        ...
        difficulty: "Začátečník",
        equipment: "Kladka",
        description: "Přítahy na spodní kladce v sedě. Bezpečný cvik pro šířku a tloušťku zad s konstantním napětím.",
      },
      {
        id: "back-12",
        name: "Meadows Row",
        ...
        difficulty: "Pokročilý",
        equipment: "Velká činka",
        description: "Jednoruční přítah landmine činky. Unikátní úhel pro maximální zapojení latissimu a zadních deltoidů.",
      },
      {
        id: "back-13",
        ...
        difficulty: "Střední",
        equipment: "Kladka",
        description: "Stahování kladky s nataženýma rukama. Izoluje latissimus bez zapojení bicepsu.",
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        difficulty: "Střední",
        equipment: "Stroj",
        description: "Dřepy na hack squat stroji. Vedený pohyb zaměřuje zátěž na kvadricepsy s minimální zátěží na záda.",
      },
      {
        id: "legs-16",
        ...
        difficulty: "Pokročilý",
        equipment: "Velká činka",
        description: "Rumunský mrtvý tah s mírnými pokrčenými koleny. Primárně cílí na hamstringy a hýždě.",
      },
      {
        id: "legs-17",
        name: "Leg Curl",
        ...
        difficulty: "Začátečník",
        equipment: "Stroj",
        description: "Zakopávání na stroji vleže nebo vsedě. Izoluje hamstringy s kontrolovaným pohybem.",
      },
      {
        id: "legs-18",
        name: "Calf Raises",
        ...
        difficulty: "Začátečník",
        equipment: "Stroj",
        description: "Výpony na lýtka na stroji nebo na stupínku. Cílí na gastrocnemius a soleus pro rozvoj lýtek.",
      },
    ],
  },
];
